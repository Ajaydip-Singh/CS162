AGMA foreign_keys = ON; -- activates foreign key features in sqlite. It is disabled by default
...
SELECT '----------------------------------------------------';
SELECT FIRSTNAME, SURNAME, EMAIL FROM Loans
    JOIN Clients ON Loans.CLIENTNUMBER = Clients.CLIENTNUMBER
